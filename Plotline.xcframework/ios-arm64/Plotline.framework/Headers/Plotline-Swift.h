...
#ifndef PLOTLINE_SWIFT_H
#define PLOTLINE_SWIFT_H
...
SWIFT_CLASS("_TtC8Plotline24MultiChoiceSingleCorrect")
@interface MultiChoiceSingleCorrect : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC8Plotline6Rating")
@interface Rating : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC8Plotline12SmileyRating")
...
SWIFT_CLASS("_TtC8Plotline12ThankYouView")
